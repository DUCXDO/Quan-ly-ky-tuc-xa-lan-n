...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer_Bright : ContainerControl
    {
        ...
        public MonoFlat_ThemeContainer_Bright()
        {
            SetStyle((ControlStyles)(139270), true);
            BackColor = Color.FromArgb(32, 41, 50);
            Padding = new Padding(10, 70, 10, 9);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Graphics G = e.Graphics;
            // sửa màu background
            G.Clear(Color.FromArgb(231, 247, 247));
            //sửa màu thanh ở trên
            G.FillRectangle(new SolidBrush(Color.FromArgb(146 , 212 , 214)), new Rectangle(0, 0, Width, 60));
            ...
            G.DrawString(Text, new Font("Microsoft Sans Serif", 12, FontStyle.Bold), new SolidBrush(Color.FromArgb(255, 254, 255)), new Rectangle(20, 20, Width - 1, Height), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
            //Vẽ đường viền phân cách
            e.Graphics.DrawLine(new Pen(Color.FromArgb(30, 186, 191)), 0, 59, Width,59);
    ...
    class MonoFlat_ControlBox_Bright : Control
    {
        ...
        public MonoFlat_ControlBox_Bright()
            : base()
        {
            DoubleBuffered = true;
            Anchor = AnchorStyles.Top | AnchorStyles.Right;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            G.Clear(Color.FromArgb(146, 212, 214));
    ...
    public class MonoFlat_Button_Green : Control
    {
        ...
        public MonoFlat_Button_Green()
        {
            ...
            Size = new Size(146, 41);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(80, 208, 125)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(22, 182, 78)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(80, 208, 125), Color.FromArgb(80, 208, 125), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(22, 182, 78), Color.FromArgb(22, 182, 78), 90.0F);
            }
    ...
    public class MonoFlat_NotificationBox_Custom : Control
    {
        ...
        public MonoFlat_NotificationBox_Custom()
        {
            SetStyle((System.Windows.Forms.ControlStyles)(ControlStyles.AllPaintingInWmPaint | ControlStyles.UserPaint | ControlStyles.OptimizedDoubleBuffer | ControlStyles.ResizeRedraw), true);
